...
public class StringNode {
    ...
    public static StringNode copy (StringNode str) {
        ...
        StringNode iter = str;
        StringNode trav = new StringNode(iter.ch, null);
        StringNode start = trav;
        iter = iter.next;

        while (iter != null) {
            trav.next = new StringNode(iter.ch, null);
            trav = trav.next;
            iter = iter.next;
    ...
    public static StringNode insertAfter(StringNode str, char newChar, char afterChar) {
        ...
        return str;
        /* */
        StringNode nullNode = new StringNode(newChar, null);
       if (str == null) {
            return nullNode;
       } else {
                ...
                if (str.ch == afterChar) {
                    ...
                    StringNode trav = new StringNode(newChar, null);
                    str.next = trav;
                    return str;
                } else {
    ...
    public static boolean isPrefix(StringNode prefix, StringNode str) {
        ...
        StringNode pref = prefix;
        StringNode iter = str;

        while (iter != null && pref != null) {
            if (iter.ch != pref.ch) {
                return false;
            } else if (iter.next == null & pref.next != null) {
                return false;
            }
            pref = pref.next;
            iter = iter.next;
